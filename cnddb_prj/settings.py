"""
Django settings for cnddb_prj project.
"""
...
DATATYPE_LOCATIONS.append('cnddb_prj.datatypes')
FUNCTION_LOCATIONS.append('cnddb_prj.functions')
...
ELASTICSEARCH_PREFIX = 'cnddb_prj'
...
WSGI_APPLICATION = 'cnddb_prj.wsgi.application'
