"""
Django settings for cnddb project.
"""
...
DATATYPE_LOCATIONS.append('cnddb.datatypes')
FUNCTION_LOCATIONS.append('cnddb.functions')
SEARCH_COMPONENT_LOCATIONS.append('cnddb.search_components')
...
SECRET_KEY = 'xh41s0-z*@cao4d@nj8w&5wr+uqe2*g9&0^*@zno(7%@9sw17q'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = 'cnddb.urls'

# a prefix to append to all elasticsearch indexes, note: must be lower case
ELASTICSEARCH_PREFIX = 'cnddb'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'cnddb.search_indexes.sample_index.SampleIndex',
...
WSGI_APPLICATION = 'cnddb.wsgi.application'
